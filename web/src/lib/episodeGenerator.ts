...
export function generateEpisodeDraft(
  ...
  return {
    ...
    thumbnailTitle: `${character.displayName}: ${template.name}`,
    thumbnailDirection: `${template.thumbnailCue}. Keep the character visually consistent: ${character.visualStyle}.`,
    ...
    exportManifest: {
      ...
      assets: ["vertical_video.mp4", "subtitles.srt", "thumbnail.png", "platform_captions.json", "review_checklist.md"],
